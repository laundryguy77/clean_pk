...
echo "This script will create GreyOS ISO from files in current directory."
...
mkisofs -o ../GreyOS_v20.iso -l -J -joliet-long -R -D -A "Kiosk" \
...
if [ $? -eq 0 ]; then
    echo "Saved as [1;33m`pwd | rev | cut -d/ -f2- | rev`/GreyOS_v20.iso[0m."
else
